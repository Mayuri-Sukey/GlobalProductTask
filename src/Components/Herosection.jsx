...
const Herosection = () => {
  const [isMenuOpen, setIsMenuOpen] = useState(false); // useStatook
  ...
  return (
    <>
      ...
      >
        <header class="flex  py-4 px-4 sm:px-10  font-[sans-serif] min-h-[135px] tracking-wide relative z-50 bg-custom-gradient" style={{
  background: 'linear-gradient(180deg, rgba(7, 7, 7, 0.5) 0%, rgba(89, 89, 89, 0) 100%) no-repeat',
          ...
          <div class="flex flex-wrap items-center gap-5 w-full">
            ...
            <div
              id="collapseMenu"
              class="max-lg:hidden lg:!flex lg:ml-auto max-lg:before:fixed max-lg:before:bg-white max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50"
            >
              <button
                id="toggleClose"
              ...
              <ul class="lg:flex gap-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                ...
                <li class="max-lg:border-b max-lg:py-3 px-3">
                  <a
                    ...
                    class="hover:text-[#007bff] text-white  block font-normal text-[14px]  font-poppins underline"
                  >
                    Home
                  </a>
                </li>
                <li class="max-lg:border-b max-lg:py-3 px-3">
                  <a
                    href="javascript:void(0)"
                    class="hover:text-[#007bff] text-white block font-normal text-[14px]  font-poppins"
                  >
                    Lab services
                  </a>
                </li>
            ...
            class='hover:text-[#007bff] text-white font-semibold block text-[15px]'>Contact</a>
        </li> */}
              </ul>
            </div>

            <div class="flex items-center max-lg:ml-auto space-x-6">
              <button class="px-4 py-2 font-normal text-[14px]  font-poppins rounded  text-white border-2 border-[#DAB82A] bg-[#DAB82A] hover:bg-[#DAB82A] transition-all ease-in-out duration-300 ">
                Sign up
              </button>
      ...
      <div class=" lg:ml-12 lg:p-10 p-6  lg:max-w-2xl sm:max-w-full ">
        <div class=" md:min-h-[340px] text-start">
          <div>
            <h3 class="text-[#3C61F7] font-normal font-[600] text-[14px] leading-[60px]  mb-4">TALK BUSINESS GROWTH</h3>
  ...
  Your Complete Regulatory Compliance Resource
            ...
            <p className="text-[#1F2933] font-normal text-[14px]  font-poppins mt-4 ">Welcome to Compliance Excellence Hub – your free portal for regulatory compliance intelligence. Access all you need to learn, assess, and manage compliance requirements efficiently..</p>
...
<button type="button"
       ...
       <div >
       <div
  className="grid lg:grid-cols-2 md:grid-cols-2  items-center lg:gap-y-6 mx-6 sm:mx-12 lg:mx-60 my-12 justify-center lg:h-[260px] sm:h-auto bg-white border border-[#1F2933]"
  style={{ boxShadow: "-4px 5px 6px #00000026" }}
>
  {/* Left Section */}
  <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
    <h2 className="text-gray-800 underline font-medium text-[22px] leading-[30px] tracking-normal text-start">
      See our <span className="text-[#FBB03B] underline decoration-[#FBB03B]">Services</span>
    </h2>

    <p className="text-[#1F2933] mt-4 text-[12px] leading-[30px] text-start">
  ...
  {/* Right Section */}
  <div className="lg:h-[260px] flex items-center bg-[#1f2933] ">
    <img
      src={group8}
